...
exports.setWrappedInfo = exports.getWrappedInfo = exports.WrapTypes = exports.formatSwaps = exports.EVMgetOutputAmountSwap = exports.getDerivativeSpotPriceAfterSwap = exports.getDerivativeSpotPriceAfterSwapForPath = exports.getSpotPriceAfterSwap = exports.getOutputAmountSwap = exports.getSpotPriceAfterSwapForPath = exports.getOutputAmountSwapForPath = exports.getEffectivePriceSwapForPath = exports.getHighestLimitAmountsForPaths = void 0;
...
function getHighestLimitAmountsForPaths(paths, maxPools) {
    console.log('@@@@@@helpersColass: getHighestLimitAmountsForPaths() paths=', paths);
    console.log('@@@@@@helpersColass: getHighestLimitAmountsForPaths() maxPools=', maxPools);
    if (paths.length === 0)
        return [];
    let limitAmounts = [];
    ...
    console.log('@@@@@@helpersColass: getHighestLimitAmountsForPaths() limitAmounts=', limitAmounts);
    return limitAmounts;
}
...
function formatSwaps(swapsOriginal, swapType, swapAmount, tokenIn, tokenOut, returnAmount, returnAmountConsideringFees, marketSp) {
    ...
    if (swapType === types_1.SwapTypes.SwapExactIn) {
        ...
        swaps.forEach((sequence) => {
            sequence.forEach((swap, i) => {
                ...
                if (i == 0) {
                    ...
                    amountScaled = (0, bmath_1.scale)((0, bmath_1.bnum)(swap.swapAmount), swap.tokenInDecimals)
                        .decimalPlaces(0, 1)
                        .toString();
        ...
        let swapAmountScaled = (0, bmath_1.scale)(swapAmount, tokenInDecimals);
        let dust = swapAmountScaled.minus(totalSwapAmount).dp(0, 0);
        if (dust.gt(0))
            swapsV2[0].amount = (0, bmath_1.bnum)(swapsV2[0].amount).plus(dust).toString();
        swapInfo.swapAmount = swapAmountScaled;
        // Using this split to remove any decimals
        swapInfo.returnAmount = (0, bmath_1.bnum)((0, bmath_1.scale)(returnAmount, tokenOutDecimals).toString().split('.')[0]);
        swapInfo.returnAmountConsideringFees = (0, bmath_1.bnum)((0, bmath_1.scale)(returnAmountConsideringFees, tokenOutDecimals)
            .toString()
            .split('.')[0]);
        ...
        */
        swaps.forEach((sequence, sequenceNo) => {
            ...
            sequence.forEach((swap, i) => {
                ...
                if (i == 0 && sequence.length > 1) {
                    ...
                    let amountScaled = (0, bmath_1.scale)((0, bmath_1.bnum)(swap.swapAmount), swap.tokenOutDecimals)
                        .decimalPlaces(0, 1)
                        .toString();
                    totalSwapAmount = totalSwapAmount.plus(amountScaled);
        ...
        // We need to account for any rounding losses by adding dust to first path
        let swapAmountScaled = (0, bmath_1.scale)(swapAmount, tokenOutDecimals);
        let dust = swapAmountScaled.minus(totalSwapAmount).dp(0, 0);
        if (dust.gt(0))
            swapsV2[0].amount = (0, bmath_1.bnum)(swapsV2[0].amount).plus(dust).toString();
        swapInfo.swapAmount = swapAmountScaled;
        // Using this split to remove any decimals
        swapInfo.returnAmount = (0, bmath_1.bnum)((0, bmath_1.scale)(returnAmount, tokenInDecimals).toString().split('.')[0]);
        swapInfo.returnAmountConsideringFees = (0, bmath_1.bnum)((0, bmath_1.scale)(returnAmountConsideringFees, tokenInDecimals)
            .toString()
            .split('.')[0]);
        swapInfo.swaps = swapsV2;
    }
...
function getWrappedInfo(provider, swapType, tokenIn, tokenOut, chainId, swapAmount) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let tokenInRate = (0, bmath_1.bnum)(1);
        let tokenOutRate = (0, bmath_1.bnum)(1);
        // Handle ETH wrapping
        ...
        if (tokenIn === index_1.Lido.stETH[chainId]) {
            ...
            const rate = yield (0, index_1.getStEthRate)(provider, chainId);
            tokenInRate = rate;
            if (swapType === types_1.SwapTypes.SwapExactIn)
...
function setWrappedInfo(swapInfo, swapType, wrappedInfo, chainId) {
    ...
    if ((wrappedInfo.tokenIn.wrapType === WrapTypes.stETH &&
        ...
        swapInfo.swapAmountForSwaps = (0, bmath_1.scale)(wrappedInfo.swapAmountForSwaps, 18).dp(0); // Always 18 because wstETH
        swapInfo.swapAmount = (0, bmath_1.scale)(wrappedInfo.swapAmountOriginal, 18).dp(0);
    }
    else {
