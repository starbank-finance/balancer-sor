...
const SUBGRAPH_URL = process.env.SUBGRAPH_URL ||
    ...
    'https://graph.starbank-finance.com/subgraphs/name/starbank-finance/balancer-v2';
...
function fetchSubgraphPools(SubgraphUrl = '') {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (SubgraphUrl.indexOf('.json') !== -1) {
            ...
            const response = yield (0, isomorphic_fetch_1.default)(SubgraphUrl === '' ? SUBGRAPH_URL : SubgraphUrl, {
                method: 'GET',
                headers: {
    ...
    `;
        console.log(`fetchSubgraphPools2: ${SubgraphUrl === '' ? SUBGRAPH_URL : SubgraphUrl}`);
        const response = yield (0, isomorphic_fetch_1.default)(SubgraphUrl === '' ? SUBGRAPH_URL : SubgraphUrl, {
            method: 'POST',
            headers: {
                Accept: 'application/json',
