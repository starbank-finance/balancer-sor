...
function getOnChainBalances(subgraphPools, multiAddress, vaultAddress, provider) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        subgraphPools.pools.forEach(subgraphPool => {
            ...
            try {
                subgraphPool.swapFee = (0, bmath_1.scale)((0, bmath_1.bnum)(onChainResult.swapFee), -18).toString();
                onChainResult.poolTokens.tokens.forEach((token, i) => {
                    ...
                    const balance = (0, bmath_1.scale)((0, bmath_1.bnum)(onChainResult.poolTokens.balances[i]), -Number(T.decimals)).toString();
                    T.balance = balance;
                    if (subgraphPool.poolType === 'Weighted')
                        T.weight = (0, bmath_1.scale)((0, bmath_1.bnum)(onChainResult.weights[i]), -18).toString();
                });
            }
            catch (err) {
