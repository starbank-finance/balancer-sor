...
exports.getLidoStaticSwaps = exports.getStEthRate = exports.isLidoStableSwap = exports.Routes = exports.Lido = void 0;
...
exports.Routes[1][`${exports.Lido.DAI[1]}${exports.Lido.wstETH[1]}0`] = {
    ...
    tokenInDecimals: 18,
    tokenOutDecimals: 18,
    tokenAddresses: [exports.Lido.DAI[1], exports.Lido.WETH[1], exports.Lido.wstETH[1]],
    swaps: [
        {
...
exports.Routes[1][`${exports.Lido.wstETH[1]}${exports.Lido.DAI[1]}0`] = {
    ...
    tokenInDecimals: 18,
    tokenOutDecimals: 18,
    tokenAddresses: [exports.Lido.wstETH[1], exports.Lido.WETH[1], exports.Lido.DAI[1]],
    swaps: [
        {
            poolId: exports.Lido.StaticPools.wstEthWeth[1],
            amount: '',
...
exports.Routes[1][`${exports.Lido.USDC[1]}${exports.Lido.wstETH[1]}0`] = {
    ...
    tokenInDecimals: 6,
    tokenOutDecimals: 18,
    tokenAddresses: [exports.Lido.USDC[1], exports.Lido.DAI[1], exports.Lido.WETH[1], exports.Lido.wstETH[1]],
    swaps: [
        {
...
exports.Routes[1][`${exports.Lido.wstETH[1]}${exports.Lido.USDC[1]}0`] = {
    ...
    tokenInDecimals: 18,
    tokenOutDecimals: 6,
    tokenAddresses: [exports.Lido.wstETH[1], exports.Lido.WETH[1], exports.Lido.DAI[1], exports.Lido.USDC[1]],
    swaps: [
        {
            poolId: exports.Lido.StaticPools.wstEthWeth[1],
            amount: '',
...
exports.Routes[1][`${exports.Lido.USDT[1]}${exports.Lido.wstETH[1]}0`] = {
    ...
    tokenInDecimals: 6,
    tokenOutDecimals: 18,
    tokenAddresses: [exports.Lido.USDT[1], exports.Lido.DAI[1], exports.Lido.WETH[1], exports.Lido.wstETH[1]],
    swaps: [
        {
            poolId: exports.Lido.StaticPools.staBal[1],
            amount: '',
...
exports.Routes[1][`${exports.Lido.wstETH[1]}${exports.Lido.USDT[1]}0`] = {
    ...
    tokenInDecimals: 18,
    tokenOutDecimals: 6,
    tokenAddresses: [exports.Lido.wstETH[1], exports.Lido.WETH[1], exports.Lido.DAI[1], exports.Lido.USDT[1]],
    swaps: [
        {
            poolId: exports.Lido.StaticPools.wstEthWeth[1],
            amount: '',
...
exports.Routes[42][`${exports.Lido.USDC[42]}${exports.Lido.wstETH[42]}0`] = {
    ...
    tokenInDecimals: 6,
    tokenOutDecimals: 18,
    tokenAddresses: [exports.Lido.USDC[42], exports.Lido.WETH[42], exports.Lido.wstETH[42]],
    swaps: [
        {
...
exports.Routes[42][`${exports.Lido.wstETH[42]}${exports.Lido.USDC[42]}0`] = {
    ...
    tokenInDecimals: 18,
    tokenOutDecimals: 6,
    tokenAddresses: [exports.Lido.wstETH[42], exports.Lido.WETH[42], exports.Lido.USDC[42]],
    swaps: [
        {
            poolId: exports.Lido.StaticPools.wstEthWeth[42],
            amount: '',
...
function isLidoStableSwap(chainId, tokenIn, tokenOut) {
    if (!exports.Lido.Networks.includes(chainId))
        return false;
    tokenIn = tokenIn.toLowerCase();
    tokenOut = tokenOut.toLowerCase();
    if ((tokenIn === exports.Lido.wstETH[chainId] && tokenOut === exports.Lido.DAI[chainId]) ||
        (tokenIn === exports.Lido.wstETH[chainId] && tokenOut === exports.Lido.USDC[chainId]) ||
        (tokenIn === exports.Lido.wstETH[chainId] && tokenOut === exports.Lido.USDT[chainId]) ||
        (tokenIn === exports.Lido.DAI[chainId] && tokenOut === exports.Lido.wstETH[chainId]) ||
        (tokenIn === exports.Lido.USDC[chainId] && tokenOut === exports.Lido.wstETH[chainId]) ||
        (tokenIn === exports.Lido.USDT[chainId] && tokenOut === exports.Lido.wstETH[chainId]) ||
        (tokenIn === exports.Lido.stETH[chainId] && tokenOut === exports.Lido.DAI[chainId]) ||
        (tokenIn === exports.Lido.stETH[chainId] && tokenOut === exports.Lido.USDC[chainId]) ||
        (tokenIn === exports.Lido.stETH[chainId] && tokenOut === exports.Lido.USDT[chainId]) ||
        (tokenIn === exports.Lido.DAI[chainId] && tokenOut === exports.Lido.stETH[chainId]) ||
        (tokenIn === exports.Lido.USDC[chainId] && tokenOut === exports.Lido.stETH[chainId]) ||
        (tokenIn === exports.Lido.USDT[chainId] && tokenOut === exports.Lido.stETH[chainId]))
        return true;
    else
        return false;
}
...
function queryBatchSwap(swapType, swaps, assets, provider) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const vaultContract = new contracts_1.Contract(vaultAddr, Vault_json_1.default, provider);
        const funds = {
        ...
        try {
            ...
            if (swapType === types_1.SwapTypes.SwapExactIn)
                return (0, bmath_1.bnum)(deltas[assets.length - 1].toString()).times(-1);
            else
                return (0, bmath_1.bnum)(deltas[0].toString());
        }
        catch (err) {
...
function calculateMarketSp(swapType, swaps, assets, pools) {
    ...
    for (let i = 0; i < swaps.length; i++) {
        ...
        const newPool = (0, pools_1.parseNewPool)(pool[0]);
        if (!newPool)
            return (0, bmath_1.bnum)(0);
        ...
        let spotPrice;
        if (swapType === types_1.SwapTypes.SwapExactIn)
            spotPrice = newPool._spotPriceAfterSwapExactTokenInForTokenOut(poolPairData, bmath_1.ZERO);
        // Amount = 0 to just get current SP
        else
            spotPrice = newPool._spotPriceAfterSwapTokenInForExactTokenOut(poolPairData, bmath_1.ZERO); // Amount = 0 to just get current SP
...
function getStEthRate(provider, chainId) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const wstETHContract = new contracts_1.Contract(exports.Lido.wstETH[chainId], wstETH_json_1.default, provider);
        const rate = yield wstETHContract.tokensPerStEth();
        return (0, bmath_1.scale)((0, bmath_1.bnum)(rate.toString()), -18);
    });
}
...
function getLidoStaticSwaps(pools, chainId, tokenIn, tokenOut, swapType, swapAmount, provider) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const staticRoute = exports.Routes[chainId][`${tokenIn}${tokenOut}${swapType}`];
        if (!staticRoute)
            return swapInfo;
        swapInfo.tokenAddresses = staticRoute.tokenAddresses;
        swapInfo.swaps = staticRoute.swaps;
        if (swapType === types_1.SwapTypes.SwapExactIn)
            swapInfo.swapAmount = (0, bmath_1.scale)(swapAmount, staticRoute.tokenInDecimals).dp(0);
        else
            swapInfo.swapAmount = (0, bmath_1.scale)(swapAmount, staticRoute.tokenOutDecimals).dp(0);
        swapInfo.swaps[0].amount = swapInfo.swapAmount.toString();
        if (isWrappingIn)
            swapInfo.tokenIn = exports.Lido.stETH[chainId];
        else
            swapInfo.tokenIn = tokenIn;
        if (isWrappingOut)
            swapInfo.tokenOut = exports.Lido.stETH[chainId];
        else
            swapInfo.tokenOut = tokenOut;
        // Calculate SP as product of all pool SP in path
        swapInfo.marketSp = calculateMarketSp(swapType, swapInfo.swaps, swapInfo.tokenAddresses, pools);
        // Unlike main SOR here we haven't calculated the return amount for swaps so use query call on Vault to get value.
        swapInfo.returnAmount = yield queryBatchSwap(swapType, swapInfo.swaps, swapInfo.tokenAddresses, provider);
