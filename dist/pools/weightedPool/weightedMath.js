...
function _exactTokenInForTokenOut(amount, poolPairData) {
    ...
    return (0, bmath_1.bnum)(Bo * (1 - Math.pow((Bi / (Bi + Ai * (1 - f))), (wi / wo))));
    // return Bo.times(
    //     bnum(1).minus(
    //         bnum(
    //             Bi.div(
...
function _tokenInForExactTokenOut(amount, poolPairData) {
    ...
    let f = poolPairData.swapFee.toNumber();
    return (0, bmath_1.bnum)((Bi * (-1 + Math.pow((Bo / (-Ao + Bo)), (wo / wi)))) / (1 - f));
    // return Bi.times(
    //     bnum(-1).plus(
...
function _exactTokenInForBPTOut(amount, poolPairData) {
    ...
    let Ai = amount.toNumber();
    let f = poolPairData.swapFee.toNumber();
    return (0, bmath_1.bnum)(Bbpt * (-1 + Math.pow((1 + (Ai * (1 - f * (1 - wi))) / Bi), wi)));
}
...
function _tokenInForExactBPTOut(amount, poolPairData) {
    ...
    let f = poolPairData.swapFee.toNumber();
    return (0, bmath_1.bnum)(((-1 + Math.pow((1 + Aobpt / Bbpt), (1 / wi))) * Bi) / (1 - f * (1 - wi)));
}
...
function _BPTInForExactTokenOut(amount, poolPairData) {
    ...
    let f = poolPairData.swapFee.toNumber();
    return (0, bmath_1.bnum)(((1 - Math.pow((1 - Aibpt / Bbpt), (1 / wo))) * Bo) / (1 - f * (1 - wo)));
}
...
function _exactBPTInForTokenOut(amount, poolPairData) {
    ...
    let Ao = amount.toNumber();
    let f = poolPairData.swapFee.toNumber();
    return (0, bmath_1.bnum)(Bbpt * (1 - Math.pow((1 - (Ao * (1 - f * (1 - wo))) / Bo), wo)));
}
...
function _spotPriceAfterSwapTokenInForExactTokenOut(amount, poolPairData) {
    ...
    let Ao = amount.toNumber();
    let f = poolPairData.swapFee.toNumber();
    return (0, bmath_1.bnum)(-((Bi * Math.pow((Bo / (-Ao + Bo)), ((wi + wo) / wi)) * wo) /
        (Bo * (-1 + f) * wi)));
}
...
function _spotPriceAfterSwapExactTokenInForBPTOut(amount, poolPairData) {
    ...
    let Ai = amount.toNumber();
    let f = poolPairData.swapFee.toNumber();
    return (0, bmath_1.bnum)((Bi * Math.pow(((Ai + Bi + Ai * f * (-1 + wi)) / Bi), (1 - wi))) /
        (Bbpt * (1 + f * (-1 + wi)) * wi));
}
...
function _spotPriceAfterSwapTokenInForExactBPTOut(amount, poolPairData) {
    ...
    let Aobpt = amount.toNumber();
    let f = poolPairData.swapFee.toNumber();
    return (0, bmath_1.bnum)((Math.pow(((Aobpt + Bbpt) / Bbpt), (1 / wi)) * Bi) /
...
function _spotPriceAfterSwapExactBPTInForTokenOut(amount, poolPairData) {
    ...
    let Aibpt = amount.toNumber();
    let f = poolPairData.swapFee.toNumber();
    return (0, bmath_1.bnum)((Math.pow((1 - Aibpt / Bbpt), ((-1 + wo) / wo)) *
        Bbpt *
        (1 + f * (-1 + wo)) *
        wo) /
        Bo);
...
function _derivativeSpotPriceAfterSwapExactTokenInForTokenOut(amount, poolPairData) {
    ...
    let Ai = amount.toNumber();
    let f = poolPairData.swapFee.toNumber();
    return (0, bmath_1.bnum)((wi + wo) / (Bo * Math.pow((Bi / (Ai + Bi - Ai * f)), (wi / wo)) * wi));
}
...
function _derivativeSpotPriceAfterSwapTokenInForExactTokenOut(amount, poolPairData) {
    ...
    let Ao = amount.toNumber();
    let f = poolPairData.swapFee.toNumber();
    return (0, bmath_1.bnum)(-((Bi * Math.pow((Bo / (-Ao + Bo)), (wo / wi)) * wo * (wi + wo)) /
...
function _derivativeSpotPriceAfterSwapExactTokenInForBPTOut(amount, poolPairData) {
    ...
    let Ai = amount.toNumber();
    let f = poolPairData.swapFee.toNumber();
    return (0, bmath_1.bnum)(-((-1 + wi) / (Bbpt * Math.pow(((Ai + Bi + Ai * f * (-1 + wi)) / Bi), wi) * wi)));
}
...
function _derivativeSpotPriceAfterSwapTokenInForExactBPTOut(amount, poolPairData) {
    ...
    let Aobpt = amount.toNumber();
    let f = poolPairData.swapFee.toNumber();
    return (0, bmath_1.bnum)(-((Math.pow(((Aobpt + Bbpt) / Bbpt), (1 / wi)) * Bi * (-1 + wi)) /
...
function _derivativeSpotPriceAfterSwapExactBPTInForTokenOut(amount, poolPairData) {
    ...
    let Aibpt = amount.toNumber();
    let f = poolPairData.swapFee.toNumber();
    return (0, bmath_1.bnum)(-(((1 + f * (-1 + wo)) * (-1 + wo)) /
