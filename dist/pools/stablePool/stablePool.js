...
class StablePool {
    ...
    parsePoolPairData(tokenIn, tokenOut) {
        ...
        let inv = (0, stableMath_1._invariant)(this.amp, allBalances);
        const poolPairData = {
            id: this.id,
    ...
    _exactTokenInForTokenOut(poolPairData, amount) {
        ...
        return (0, stableMath_1._exactTokenInForTokenOut)(amount, poolPairData).dp(poolPairData.decimalsOut, 1);
    }
    _exactTokenInForBPTOut(poolPairData, amount) {
        return (0, stableMath_1._exactTokenInForBPTOut)(amount, poolPairData);
    }
    _exactBPTInForTokenOut(poolPairData, amount) {
        return (0, stableMath_1._exactBPTInForTokenOut)(amount, poolPairData);
    }
    _tokenInForExactTokenOut(poolPairData, amount) {
        // Using BigNumber.js decimalPlaces (dp), allows us to consider token decimal accuracy correctly,
        // i.e. when using token with 2decimals 0.002 should be returned as 0
        // Uses ROUND_UP mode (0)
        return (0, stableMath_1._tokenInForExactTokenOut)(amount, poolPairData).dp(poolPairData.decimalsIn, 0);
    }
    _tokenInForExactBPTOut(poolPairData, amount) {
        return (0, stableMath_1._tokenInForExactBPTOut)(amount, poolPairData);
    }
    _BPTInForExactTokenOut(poolPairData, amount) {
        return (0, stableMath_1._BPTInForExactTokenOut)(amount, poolPairData);
    }
    _spotPriceAfterSwapExactTokenInForTokenOut(poolPairData, amount) {
        return (0, stableMath_1._spotPriceAfterSwapExactTokenInForTokenOut)(amount, poolPairData);
    }
    _spotPriceAfterSwapExactTokenInForBPTOut(poolPairData, amount) {
        return (0, stableMath_1._spotPriceAfterSwapExactTokenInForBPTOut)(amount, poolPairData);
    }
    _spotPriceAfterSwapExactBPTInForTokenOut(poolPairData, amount) {
        return (0, stableMath_1._spotPriceAfterSwapExactBPTInForTokenOut)(amount, poolPairData);
    }
    _spotPriceAfterSwapTokenInForExactTokenOut(poolPairData, amount) {
        return (0, stableMath_1._spotPriceAfterSwapTokenInForExactTokenOut)(amount, poolPairData);
    }
    _spotPriceAfterSwapTokenInForExactBPTOut(poolPairData, amount) {
        return (0, stableMath_1._spotPriceAfterSwapTokenInForExactBPTOut)(amount, poolPairData);
    }
    _spotPriceAfterSwapBPTInForExactTokenOut(poolPairData, amount) {
        return (0, stableMath_1._spotPriceAfterSwapBPTInForExactTokenOut)(amount, poolPairData);
    }
    _derivativeSpotPriceAfterSwapExactTokenInForTokenOut(poolPairData, amount) {
        return (0, stableMath_1._derivativeSpotPriceAfterSwapExactTokenInForTokenOut)(amount, poolPairData);
    }
    _derivativeSpotPriceAfterSwapExactTokenInForBPTOut(poolPairData, amount) {
        return (0, stableMath_1._derivativeSpotPriceAfterSwapExactTokenInForBPTOut)(amount, poolPairData);
    }
    _derivativeSpotPriceAfterSwapExactBPTInForTokenOut(poolPairData, amount) {
        return (0, stableMath_1._derivativeSpotPriceAfterSwapExactBPTInForTokenOut)(amount, poolPairData);
    }
    _derivativeSpotPriceAfterSwapTokenInForExactTokenOut(poolPairData, amount) {
        return (0, stableMath_1._derivativeSpotPriceAfterSwapTokenInForExactTokenOut)(amount, poolPairData);
    }
    _derivativeSpotPriceAfterSwapTokenInForExactBPTOut(poolPairData, amount) {
        return (0, stableMath_1._derivativeSpotPriceAfterSwapTokenInForExactBPTOut)(amount, poolPairData);
    }
    _derivativeSpotPriceAfterSwapBPTInForExactTokenOut(poolPairData, amount) {
        return (0, stableMath_1._derivativeSpotPriceAfterSwapBPTInForExactTokenOut)(amount, poolPairData);
    }
    _evmoutGivenIn(poolPairData, amount) {
        try {
            ...
            const amt = SDK.StableMath._calcOutGivenIn(this.ampAdjusted, poolPairData.allBalancesScaled, poolPairData.tokenIndexIn, poolPairData.tokenIndexOut, amtScaled, poolPairData.swapFeeScaled);
    ...
    _evminGivenOut(poolPairData, amount) {
        try {
            ...
            // i.e. 1USDC => 1e18 not 1e6
            const amtScaled = (0, bmath_1.scale)(amount, 18);
            const amt = SDK.StableMath._calcInGivenOut(this.ampAdjusted, poolPairData.allBalancesScaled, poolPairData.tokenIndexIn, poolPairData.tokenIndexOut, amtScaled, poolPairData.swapFeeScaled);
            // return normalised amount
            return (0, bmath_1.scale)(amt, -18);
        }
        catch (err) {
